        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SoDienThoai = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GiamGiaDanhMuc", x => x.ID);
                    table.ForeignKey(
                        name: "FK_GiamGiaDanhMuc_DanhMucs_DanhMucId",
                        column: x => x.DanhMucId,
                        principalTable: "DanhMucs",
                        principalColumn: "DanhMucId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GiamGiaDanhMuc_GiamGias_IDGiamGia",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NgayTao = table.Column<DateTime>(type: "datetime2", nullable: true),
                    NgaySua = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IdVoucher = table.Column<Guid>(type: "uniqueidentifier", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GiamGiaSanPham", x => x.ID);
                    table.ForeignKey(
                        name: "FK_GiamGiaSanPham_GiamGias_IDGiamGia",
                        column: x => x.IDGiamGia,
                        principalTable: "GiamGias",
                        principalColumn: "IDGiamGia",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GiamGiaSanPham_SanPhams_IDSanPham",
                        column: x => x.IDSanPham,
                        principalTable: "SanPhams",
                        principalColumn: "IDSanPham",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HoaDonTrangThai", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HoaDonTrangThai_HoaDons_IDHoaDon",
                        column: x => x.IDHoaDon,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodeVoucher = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ...
                    DieuKienToiThieu = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    SoLuong = table.Column<int>(type: "int", nullable: true),
                    SoLanSuDungToiDa = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vouchers_HoaDons_IdVoucher",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GiamGiaSPCT", x => x.ID);
                    table.ForeignKey(
                        name: "FK_GiamGiaSPCT_GiamGias_IDGiamGia",
                        column: x => x.IDGiamGia,
                        principalTable: "GiamGias",
                        principalColumn: "IDGiamGia",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GiamGiaSPCT_SanPhamChiTiets_IDSanPhamCT",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HoaDonChiTiets_SanPhamChiTiets_IDSanPhamCT",
                        column: x => x.IDSanPhamCT,
                        principalTable: "SanPhamChiTiets",
                        principalColumn: "IDSanPhamCT",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GiamGiaDanhMuc_DanhMucId",
                table: "GiamGiaDanhMuc",
                column: "DanhMucId");

            migrationBuilder.CreateIndex(
                name: "IX_GiamGiaDanhMuc_IDGiamGia",
                table: "GiamGiaDanhMuc",
                column: "IDGiamGia");

            migrationBuilder.CreateIndex(
                name: "IX_GiamGiaSanPham_IDGiamGia",
                table: "GiamGiaSanPham",
                column: "IDGiamGia");

            migrationBuilder.CreateIndex(
                name: "IX_GiamGiaSanPham_IDSanPham",
                table: "GiamGiaSanPham",
                column: "IDSanPham");

            migrationBuilder.CreateIndex(
                name: "IX_GiamGiaSPCT_IDGiamGia",
                table: "GiamGiaSPCT",
                column: "IDGiamGia");

            migrationBuilder.CreateIndex(
                name: "IX_GiamGiaSPCT_IDSanPhamCT",
                table: "GiamGiaSPCT",
                column: "IDSanPhamCT");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HoaDonChiTiets_IDSanPhamCT",
                table: "HoaDonChiTiets",
                column: "IDSanPhamCT");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HoaDonTrangThai_IDHoaDon",
                table: "HoaDonTrangThai",
                column: "IDHoaDon");
